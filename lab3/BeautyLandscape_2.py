...
def bush(r, col_fl_int, col_fl_d, col_fl_ctr, col_bsh):
    sur = pygame.Surface((20 * r, 20 * r), pygame.SRCALPHA)
    circle(sur, col_bsh, (10*r, 10*r), 10*r)
    for i in range(3):
        sur.blit(pygame.transform.rotate(
            pygame.transform.scale(
                flower(col_fl_int, col_fl_d, col_fl_ctr), (10*r + 2 * r * i, r + 2 * r * i)), -r * 200 + i * r),
            (3 * r, 3 * r))

    for i in range(3):
        sur.blit(pygame.transform.rotate(
            pygame.transform.scale(
                flower(col_fl_int, col_fl_d, col_fl_ctr), (200 + 50 * i, 200 + 50 * i)), -20 + i * 40),
            (r, 0.3 * r))
    return sur
...
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (100, 100)), (-10, 570))
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (200, 200)), (650, 500))
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (300, 300)), (530, 750))
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (50, 50)), (430, 530))
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (75, 75)), (330, 530))
sc.blit(pygame.transform.scale(bush(20, WHITE, BLACK, YELLOW, DARK_GREEN), (80, 80)), (500, 600))

sc.blit(pygame.transform.scale(notunicorn(), (700, 700)), (-270, 760))
sc.blit(pygame.transform.scale(notunicorn(), (150, 150)), (270, 500))
sc.blit(pygame.transform.scale(notunicorn(), (150, 150)), (190, 600))

sc.blit(pygame.transform.scale(pygame.transform.flip(notunicorn(), True, False), (100, 100)), (350, 600))
sc.blit(pygame.transform.scale(pygame.transform.flip(notunicorn(), True, False), (500, 500)), (450, 600))
