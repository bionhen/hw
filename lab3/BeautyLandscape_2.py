...
def flower(): #создаёт surface с цветочком
    ...
    for i in range(3):
        ...
        ellipse(sur,BLACK,(5+25*i,12-12*(i%2),50,25), width=2)
    ellipse(sur, YELLOW, (35,20,50,25))
    for i in range(2):
        ellipse(sur,WHITE,(60-12*i,20+i*15,50,25))
        ellipse(sur,BLACK,(60-12*i,20+i*15,50,25), width=2)
    for i in range(2):
        ellipse(sur,WHITE,(20-20*i,35-i*5,50,25))
        ellipse(sur,BLACK,(20-20*i,35-i*5,50,25), width=2)
    return sur
...
sc.blit(pygame.transform.scale(bush(),(100,100)),(-10,570))
sc.blit(pygame.transform.scale(bush(),(200,200)),(650,500))
sc.blit(pygame.transform.scale(bush(),(300,300)),(530,750))
sc.blit(pygame.transform.scale(bush(),(50,50)),(430,530))
sc.blit(pygame.transform.scale(bush(),(75,75)),(330,530))
sc.blit(pygame.transform.scale(bush(),(80,80)),(500,600))
